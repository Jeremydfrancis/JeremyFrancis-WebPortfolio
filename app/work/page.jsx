...
const projects = [
  {
    ...
    description: 'This web application serves as a modern, responsive website for a Mediterranean restaurant, created as the final capstone for the Meta Front-End Developer Certificate. It provides visitors with an inviting platform to explore the menu, learn about the restaurant’s story, and make reservations seamlessly online. The project highlights a clean user interface, smooth navigation, and interactive forms, showcasing practical front-end development skills and best practices.',
    stack: ['Swiper','Vitest','Javascript','React JS','Vite' ],
    image: '/LittleLemon1.png',
    live: 'https://little-lemon-restaurant-gamma.vercel.app/',
    github: 'https://github.com/Jeremydfrancis/little-lemon',
  },
  {
    num: '2',
    category: 'Fullstack',
